...
Uso:
  ...
  uv run --with pypdf python finalize.py diario
  uv run --with pypdf python finalize.py guia bussola semanal diario pontes
"""
...
ORDER = ["guia", "bussola", "semanal", "diario", "pontes"]
...
if __name__ == "__main__":
    ...
    merged = merge(order, f"{D}/planner-v2-proto-rgb.pdf")
    out = to_pdfx(merged, f"{D}/planner-v2-proto-pdfx1a.pdf")
    if out:
        inkcov(out)
