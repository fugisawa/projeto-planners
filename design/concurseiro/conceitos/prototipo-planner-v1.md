# Protótipo do Planner v1 — 1 ciclo (spec de impressão)

**20/jun/2026.** Transforma os [wireframes](wireframes-planner-v1.md) num caderno-protótipo de
**1 ciclo (~1 mês)** para teste de uso real. Conceito validado com a Mayara (19/jun/2026).
...
- **Traçado:** **dot grid** (~5 mm) nas áreas livres; grades específicas nas seções (time-log etc.).
- **Perpétuo** (sem datas impressas) · **lay-flat** (abre plano).

## Composição do miolo — 1 ciclo (~1 mês)

| Bloco | Seção | Páginas | Ref. wireframe |
|---|---|---|---|
| Frontmatter | Bússola da Jornada (objetivo · mapa do edital macro · meu stack · calendário de provas) | 4 | Pág. 3 |
| Ciclo | Semanal — Ciclo de Matérias | 5 (1/semana) | Pág. 2 |
| Ciclo | Diário de Foco | 31 (1/dia) | Pág. 1 |
| Ciclo | Pontes Digitais | 4 (1/semana) | Pág. 4 |
| Ciclo | Balanço mensal | 1 | Pág. 3 |
| Seção | Diagnóstico de Erro (lite) | 16 (2 fichas/pág → ~32 fichas) | Pág. 5 |
| Seção | Notas livres (dot grid) | 8 | — |
| Endmatter | Conteúdo curado (lei seca/súmula/frase de aprovado) + créditos | 2 | — |
...
- **Liso o suficiente** (não poroso/áspero), com leve toque — **não** couché brilhante.
...
- **Firme** para escrever segurando na mão + **resistente a amassar a orelha**.
- **Não** precisa ser capa dura; **não** precisa ser plástico.
- Alvo provável: **cartão ~300 g + laminação fosca/soft-touch** (flexível-firme) ou capa *flexi*;
  avaliar **cantos arredondados** (anti-orelha).

## Encadernação `[a confirmar no #2]`
Lay-flat obrigatório. **Wire-o (espiral dupla), topo ou lateral** (barato, abre 360°) × **costurada
